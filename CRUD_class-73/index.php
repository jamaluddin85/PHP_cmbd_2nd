...
<head>
    ...
    <title>image upload & show image</title>
</head>
<body>
   <form action="" method="$_POST" enctype="multipart/form-data">
        <input type="file" name="filename" accept="image/gif, image/jpeg, image/png, application/pdf, .csv, .xlsx, .docx">
   </form> 

 <script> //preview/show image before upload by javascript
...
<h1>=========== another option / show image ==============</h1>
